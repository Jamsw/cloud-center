...
@Configuration
@Slf4j
public class CheckLegalFilter implements GlobalFilter {
...
//        if (permissionService.permission(authentication, url, method)) {
        if(true && !StringUtils.isEmpty(authentication)){
